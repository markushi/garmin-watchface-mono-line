...
class WatchFaceView extends WatchUi.WatchFace {
  ...
  public function initialize() {
    ...
    _minuteTextOffsetY = _hourTextOffsetY;
    ...
    _dateTextOffsetY = _hourTextOffsetY + hourFontHeight - dateFontHeight;

    var tinyFontHeight = Graphics.getFontHeight(Graphics.FONT_TINY);

    _batteryOffsetY = settings.screenHeight / 20;
    _batteryIconOffsetY = _batteryOffsetY + tinyFontHeight - 2;
    _batteryIconWidth = 50;
  ...
  private function updateWatchOverlay(isFullUpdate as Boolean) as Void {
    ...
    if (drawLayerDc != null) {
      ...
      var batteryStr = Lang.format("$1$T", [
      ...
      drawLayerDc.setColor(Graphics.COLOR_BLACK, Graphics.COLOR_BLACK);
      var batteryFullInPx = (
      ...
      drawLayerDc.fillRectangle(
        _batteryIconOffsetX + _batteryIconPadding + batteryFullInPx,
        _batteryIconOffsetY + _batteryIconPadding,
        _batteryIconWidth -
          batteryFullInPx -
          _batteryIconPadding -
          _batteryIconPadding,
        _batteryIconHeight - _batteryIconPadding - _batteryIconPadding
      );
